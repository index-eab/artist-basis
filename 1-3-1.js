...
(function() {
	...
	function saveChanges(callback) {
		...
		checkChanges(function() {
			...
			console.log('Ending compressed: ', compressed);
			console.log('Ending prefs: ', prefs);
	...
	function firstTime() {
		...
		prefs = { 'watchlist': ["fuzzamorous","blitzdrachin","whalegourd","luxurias","dracojeff","minmiki","soupgecko","dark_violet","cherrikissu","vhsdaii","sebaxn","driverbunny37","glopossum","yuki_hiroshi","cate_wurtz","haps","hoodie_stalker","b2u5n","mei_(artist)","cumdog","solarjay","ajin","rikuaoshi","rika","yeenr","mistleinn","rebrokota","bastika","jeffthehusky","theyton","cat-twink","platracc","radcanine","karnator_(artist)","box_(hajimeyou654)","evenytron","foldblank","chasm-006","manmosu_marimo","wielder","caramel-kitteh","mix_2180","jooshy","artararam","nukde","a_dusty_wolf","chowdie","torata3220","bobert","yami_drake","rickyusedsketch","bbones","floogle","jayaero","owantogohan","ayden_feuer","temoru","vaktus","llmixll","2pillowprincess","jamesfoxbr","mathythemathy","creambake","ryujisama","ulitochka","yorutamago","rsotart","bigdead93","nekowuwu","kemosara","花形京介","makowolf1","riendonut","nashiholy","allfluffyears","rlerofevrything","finaladversary","savkate","didihell","malicekira","dangermd","pata","dogshenanigans","icetigerkitten","ohanamaila","shevaara","edriann","blueumbra","wooorf","romecartoons","49ersrule07_(artist)","akacia","yliade","siamasi","varisart","wyszeniega","pacificside18","gatogenerico","curritos","mimakari","artxvibe","zeriie","artsehole","othalam","magnetiorchid","nifa95073356","emukhui69472","absedgy","sponder","jinnsart","boonedog","kenzakisenpai","kings-gz","hector-collector","abraxocleaner","sergevna","barontoko","dappypappy","neyonical","tobyou_222","pechenbko","犬丸","weishaupt","velvetomo","kumasuke05131","dephy","sirdov-irkana","resurgam_snova","nighttrap","masterelrest","smokybacon","vanillabean-bunny","zakoko","kamuo","celdragon","sufficient.","realhemora","tawamure","junasgvol","teethysin","erinprimette","lacussky","littlemissburton","seaweed_jay","cinderdmutt","tasakikiki","aj-illustrated","snasaggin","moikaloop","badgerben","vennelour","norainu061306","bundcake","pandaischub","sarybomb","zipang_(zip@ng_works)","withard","sophiepoof","sruzhrt","stefano_carta","danielsilverwolf","kazutwo88888","tzoli","bigdaddysnek","slatertoons","sweetluna4444","purpleblep","zeolandia","cecilia_giménez","headless_hound_art","tinytunaroll","taakayama","uriel_urticus","dreamchanart","chunkysoup","lumirayne","smutichi","punstar","pastelmochi","zuckergelee","trainboy","walrusmastah","twilightfox133","misonikomiii47","saimatuska","inklop","secretanimal","tirrel","f0rever13","cinnamonnnnnlol","justdrawingproductions","tas-alt","momoiroink","klux_redyard","gurano","jack0w0lantern","sakayume","reggiehedgie","concavedskull","rubencondrai","byolith","mattvalkyrie","gareit0","air-city","sinribbons","alystair-the-cat","ie_(artist)","kaijuwaifu","migawaridoll","doxmartin","hannahbettearts","bonfirefox","foxnick12","kllza","neckonnirosu","firolina","imomushi","pyohato","moyamoya_kuroi","roverraven","anon_bardos","alice_yagami_art","sfm-paws","leakyroot","lovelace_devonshire","chobiluck","pondis","luna-tic","sayuttan","roxoah","oafmeal_(artist)","nauyaco","edelwood","kilolf_pendragon","pepodoodles","guyjushy","nara41x","carpediemx","permo2003","rokacake","srfennec","blgfrogs","ikarie","tiny_mocha_deer","ziogon","adma228","kitsunartbr","zeldamiley","miradge0alaricreat0","hagom","mido_midori","vatnos","novacantnames","tenjyo_k","yohiri","gryffindor131","ywjbkzalt80rwgi","lewd_no_jutsu","tamada_heijun","moeouji","tomathao","lingye","keihh","vetoknox","ladyyatexel","3_7_3_k","rak","notarealdoctor","mascarporne","takuya_tail","peroncho","tofu_(artist)","amedama_akihito","spadenightmaren","loafinglion","bakugeki_no_g","ilitiaforever","daygrabs","blade_ride","zomboyde","nerd031","monkeyman","saltwaterhermit","arelus","dubidobi","natnay","vespertellino","robotboob","godzukigooch","zargon-yokoshima","lim_(artist)","rcasco","lip-mtはるひぐらし","peppertombstudios","athenawhite777","gin_(artist)","dandybadger","johnmamer","oralavvy","alexiswolfy_(artist)","morrisonmhut","mruniverswolf","シンドウマユミ","minatumi3723","ardham","nagisabus","squidmemee","dustedpollen","kistunekit","susanoomon_(artist)","isei-silva","めご","rabbitasaur","lunarlilac","foxinks","oca_(artist)","xollipus","redrilvi","shittyrecolor","finsternis457","cheeb_(artist)","deranged_dragonfruit","icam2k","hiroyko_art","feztiz","redpetit","caio_santos","sandsquatch","liqueurmask","mario-reg","horsecat","acealari","kalfy","triballis","tutan-koopa","jacquesrabbit","sirufi","renol","ktanaka18815213","milanos","thanatosmarcel","rileythefox3","johannfaust","haiyme","citrodrop","nanasu","sarmata_mra","neneko103","k0bit0wani","sushikawa","hardknotsart","palcepyatka","homohomofever","dewstar_(artist)","hicheeras","sn0wyangel","despicablecrowbutt","tea_nakenashi","twirlyful","joeydangerous","jenbe","pirateferret","tiwwas","daiidalus_(artist)","anixaila","blysill","adam_m","maxgbf","kurobanex","kalamer_ruki","mestiso_(artist)","gatchmon_(artist)","kuranosuke","natsuno_hamuto","samezamekoban","しろ紅茶","bbbucky_p","greencooo","リョク","もchi2","karuno","runiko_e","fluffy_land","源内まお","zassou","shocio","tonylalimace","minthead_(artist)","tussytots","goldeyboi","cherartsthings","beekirbydrawsstuff","tsukikoha","黒アリ","dash-the-cheetah","pokey_mcpwicklepants","dragon-v0942","penpon","nekoguchi","fek"], 'blacklist': {}, 'cache': {} };
