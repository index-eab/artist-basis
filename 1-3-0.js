...
// @match        *://*.e621.net/*
// @match        *://*.e926.net/*
// @updateURL    https://openuserjs.org/meta/index-eab/Artist_Watchlist.meta.js
// @downloadURL  https://openuserjs.org/src/scripts/index-eab/Artist_Watchlist.user.js
...
(function() {
	...
	style = () => `
		...
		.eab:not(.favlist) .sidebar {
		...
		} .eab .post-score .eabWiki, .eab .post-score .eabHeart {
			float: left;
			width: 0;
			padding: 0;
			...
			opacity: 0;
			border: none;
		} .eab .thumb:hover .post-score .eabHeart, .eab .thumb:hover .post-score .eabWiki {
			padding: 0 5px;
			width: initial;
			opacity: 1;
	...
	let layers = [
		...
		{ time: 60*60*7*24, desc: 'Past week' },
	...
	function httpRequest(method, page, url, data, callback) {
		...
		page.setRequestHeader('User-Agent', 'Artist_Watchlist/1.3');
